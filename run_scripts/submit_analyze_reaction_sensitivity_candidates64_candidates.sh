#!/bin/bash
#SBATCH --job-name=analyze_reaction_sensitivity_candidates64_candidates
...
pixi run python -m mist.analyze_reaction_sensitivity \
    --model-ckpt results/nist23_fp_mist_candidates64/split_1/split_1/last.ckpt \
    ...
    --num-workers 16 \
    --gpu \
    --save-dir results/nist23_fp_mist_candidates64/split_1/split_1/preds_candidates
